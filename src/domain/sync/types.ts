...
export const SYNCED_COLLECTIONS = [
  ...
  // Cooking. Leftovers especially: knowing what is in the fridge is useless if it
  // only exists on the device that happened to do the cooking.
  'cookedMeals', 'leftovers', 'mealLog',
] as const;
