 ...
 * is this set to".
 *
 * THE BANDS ARE NOT SECTIONS. `SettingsBand` prints a label over a run of
 * related sections and nothing else: no fold, no state, no border to make it look
 * like a container. A second level of folding would mean two taps to reach a
 * control that used to take none, and the bands exist to make thirteen headings
 * scannable rather than to hide them.
 *
 ...
 * one-button headings at the end — kitchen, sync, data, works cited — is now a
 * single band of buttons, since a heading whose entire contents is one button is
 * a heading that earns nothing.
 */
...
export function SettingsScreen({ state }: { state: AppState }): JSX.Element {
  ...
  return (
    <main className="screen">
      ...
      {/* ============================================================== eat */}
      <SettingsBand label="What you eat" />
      ...
      {/* =========================================================== extras */}
      <SettingsBand label="Extras in the bag" />
      ...
      {/* ========================================================= shopping */}
      <SettingsBand label="Shopping & pantry" />
      ...
      <SettingsBand label="Kitchen, sync & data" />
...
/**
 * The label over a run of related sections.
 *
 * Presentational and deliberately inert — it is a caption, not a container, so it
 * does not wrap what follows it. Wrapping would make it a second thing to fold,
 * and burying "Allergies" two taps deep to save a line of screen is not a trade
 * worth making.
 */
function SettingsBand({ label }: { label: string }): JSX.Element {
